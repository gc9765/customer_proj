...
#define WIFI_MAX_STA_CNT                1           //最多连接sta的数量。有效值为1~8
...
///////////////uart1////////////
#define PIN_UART0_TX PA_10//PA_9
...
#define PIN_LCD_EN 255
#define PIN_ADKEY_IO PA_3
#define BAT_ADC_IO   PA_11
#define POWER_HOLD_PORT   255
#define PIN_LCD_BLIGHT 255

//新增加,由于新增加功能不全,暂时用宏隔离,保留旧的逻辑
#define LVGL_STREAM_ENABLE  0  //关闭流式LCD显示
///////////////LCD/////////////
...
#define PIN_SPI1_CS     NULL
#define PIN_SPI1_CLK    NULL
#define PIN_SPI1_IO0    NULL 

 
#define PIN_SPI0_CS  255//PA_13//
#define PIN_SPI0_CLK 255//PA_14//
#define PIN_SPI0_IO0 255//PE_3//
#define PIN_SPI0_IO1 255 
#define PIN_SPI0_IO2 255
#define PIN_SPI0_IO3 255


// printer demo lcd cfg
...
#define SDH_I2C2_REUSE    (1 && DVP_EN && SDH_EN)
...
#define CUSTOM_PSRAM_SIZE   800*1024
...
//是能5m/20m共存和自动带宽切换，
#define WIFI_FEM_CHIP		LMAC_FEM_GSR2701
#define LMAC_BGN_PCF
