...
#define DUPLEX_TYPE    FULL_DUPLEX //音频配置成全双工
...
#define INTERCOM_SERVER        BABY_ROLE_SERVER
#define INTERCOM_CLIENT        BABY_ROLE_CLIENT
...
#if LOSE_STATISTICAL
	if(os_jiffies()-last_statistical_time > 2000) {
