    ...
    switch (dev_id) {
        case HG_LCDC_DEVID:
            ...
            if(VS_CS != 255){
                ...
                gpio_driver_strength(VS_CS, GPIO_DS_28MA);
            }
            ...
            if(HS_DC != 255){
                ...
                gpio_driver_strength(HS_DC, GPIO_DS_28MA);
            }
            ...
            if(DE_ERD != 255){
                ...
                gpio_driver_strength(DE_ERD, GPIO_DS_28MA);  
            }
            ...
            if(DOTCLK_RWR != 255){
                ...
                gpio_driver_strength(DOTCLK_RWR, GPIO_DS_28MA);  
            }
