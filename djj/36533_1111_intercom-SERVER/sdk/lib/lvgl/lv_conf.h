...
// void *os_malloc_psram(size_t size);
// void os_free_psram(void *ptr);
// void *os_realloc_psram(void *ptr, size_t size);
void hw_memset(void * dest, unsigned char val, unsigned int n);
void hw_memcpy0(void *dest, const void *src, unsigned int size);
#define LV_MALLOC       custom_malloc_psram   
#define LV_REALLOC      custom_realloc_psram
#define LV_FREE         custom_free_psram
#define LV_MEMSET       hw_memset
#define LV_MEMCPY       hw_memcpy
...
#define LV_USE_FREETYPE 0
    ...
    #define LV_FREETYPE_CACHE_SIZE (512 * 1024)
    ...
    #define LV_FREETYPE_CACHE_FT_FACES 128
